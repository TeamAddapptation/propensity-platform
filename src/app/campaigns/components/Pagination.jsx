...
export const Pagination = ({ table, totalPages }) => {
	return (
			...
			<div className='hidden sm:flex sm:flex-1 sm:items-center sm:justify-between'>
				<div>
					<p className='text-sm text-gray-700'>
						Showing <span className='font-medium'>1</span> to <span className='font-medium'>10</span> of <span className='font-medium'>{totalPages}</span> results
					</p>
				</div>
				<div>
